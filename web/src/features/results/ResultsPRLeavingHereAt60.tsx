...
export function ResultsPRLeavingHereAt60() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        {/* Status label */}
        <p className="text-sm text-slate-500 mb-8">
          Permanent resident or citizen · Leaving Australia · Will be here at 60
        </p>
        ...
        <div className="bg-slate-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-lg text-slate-600">
            You save tax on the way in, and can withdraw your super tax-free before you leave
            Australia. The key is getting the timing right.
          </p>
        </div>
