// DASP tax rate for other temporary visa holders (482/457, 820) on the taxable component.
...
export function ResultsTempLeaving() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        {/* Status label */}
        <p className="text-sm text-slate-500 mb-8">
          Temporary visa (482 / 457 · 820) · Planning to leave Australia
        </p>
        ...
        <div className="bg-slate-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-lg text-slate-600">
            ...
            contributing in the first place. The exit tax is lower than for Working Holiday
            visa holders, but it still wipes out the upfront tax saving.
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-slate-700">Super after DASP (35% exit tax)</span>
                <span className="text-slate-900 font-medium">$0.55</span>
              </div>
              <div className="h-12 bg-slate-100 rounded">
                <div
          ...
          <p className="text-sm text-slate-500 mt-6">
            For every $1 put into super, you receive $0.55 after DASP — compared to $0.675
            kept as salary. The 15% tax saving going in is more than cancelled out by the 35%
            exit tax going out.
          </p>
        </div>
        ...
        <div className="border border-slate-200 bg-slate-50 rounded-lg p-6 mb-12">
          ...
          <p className="text-slate-700 leading-relaxed">
            If you become a permanent resident, DASP disappears entirely — you'd no longer face
            an exit tax on your super. If that happens, come back and select your new visa type.
