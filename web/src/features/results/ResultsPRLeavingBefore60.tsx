...
export function ResultsPRLeavingBefore60() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        {/* Status label */}
        <p className="text-sm text-slate-500 mb-8">
          Permanent resident or citizen · Leaving Australia, or not sure · May leave before 60
        </p>
        ...
        <div className="bg-slate-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-lg text-slate-600">
            If you can withdraw in Australia at 60, contributing is clearly worthwhile. If you
            access super from the UK, it depends on whether you'll be a basic or higher rate
            taxpayer.
          </p>
        </div>
